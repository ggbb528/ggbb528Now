  ...
  return (
    <div className="container mx-auto text-lg block max-w-sm">
      ...
      <div className='flex gap-2 py-2 px-4 text-sm'>
        <div className='w-20'>
          <a className='flex items-center justify-start gap-1  text-gray-500 hover:text-primary' href="#" onClick={() => openURL('https://github.com/ggbb528/ggbb528now/')} >
            <FaGithub />
            <span>Github</span>
          </a>
        </div>
        <div className='w-20' >
          <a className='flex items-center justify-start gap-1  text-gray-500 hover:text-primary' href="#" onClick={() => openURL('src/pages/updates/index.html')} >
            <FaHistory />
            <span>更新紀錄</span>
          </a>
        </div>
